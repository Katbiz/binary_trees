 ...
 * @value: A value to remove in the tree
 * Return: A pointer to the new root node of the tree after removing the desired
 * value
 */
...
/**
 * bst_min_node - this finds the minimum node in a binary search tree.
